# 📚 Repositori Mata Kuliah Algoritma dan Pemrograman

![Mata Kuliah](https://img.shields.io/badge/Mata%20Kuliah-Algoritma%20%26%20Pemrograman-blue)
...
Pusat sumber daya digital resmi untuk mata kuliah **Algoritma dan Pemrograman** di Universitas Sultan Ageng Tirtayasa (UNTIRTA). Repositori ini berisi semua materi perkuliahan, script kode R, informasi penting, dan tautan pendukung untuk mahasiswa.
...
**[Buka Kumpulan Ebook & Referensi](https://untirtaacid-my.sharepoint.com/:f:/g/personal/ferdian_bangkit_untirta_ac_id/EjF4_0A6aQlFjiNxxf-I2kwBr0OyMyYR1rL1PCTQIyoQIQ?e=YEsP8D)**

## ✨ Isi Repositori

- **Modul & Materi PDF**: Materi presentasi lengkap untuk setiap pertemuan, mencakup konsep dasar, struktur data, dan berbagai algoritma.
- **Kumpulan Kode R**: Script (`.R`) dan R Markdown (`.Rmd`) yang digunakan untuk praktik implementasi algoritma (seperti sorting, searching, dll) di kelas.
- **Silabus & RPS**: Rencana Pembelajaran Semester (RPS) dan silabus sebagai panduan utama perkuliahan.
- **Dataset**: Kumpulan data yang digunakan untuk latihan dan tugas (jika ada).
- **Tautan Pendukung**: Kumpulan tautan eksternal (misal: visualisasi algoritma, tutorial) untuk memperdalam pemahaman materi.
...
- **Referensi**: `SharePoint / Google Drive`
- **Platform**: `GitHub`
...
    Buka file `.R` atau `.Rmd` yang telah Anda unduh menggunakan RStudio untuk melihat dan menjalankan kode implementasi algoritma secara langsung.
